...
function SessionProvider({ children }) {
    ...
    const [currentShop, setCurrentShop] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [theme, setThemeState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('orange');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SessionProvider.useEffect": ()=>{
            try {
                ...
                const t = localStorage.getItem(THEME_KEY) || 'orange';
                setThemeState(t);
            } catch  {
            // ignore
            } finally{
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SessionProvider.useCallback[login]": (u, s)=>{
            setUser(u);
            setShops(s);
            // Auto-select first shop if user has only one, else null (will show picker)
            const initialShop = s.length === 1 ? s[0] : u.shopId ? s.find({
                "SessionProvider.useCallback[login]": (x)=>x.id === u.shopId
            }["SessionProvider.useCallback[login]"]) || s[0] : null;
    ...
    const selectShop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SessionProvider.useCallback[selectShop]": (shop)=>{
            setCurrentShop(shop);
            const raw = localStorage.getItem(STORAGE_KEY);
            if (raw) {
                try {
            ...
            if (shop.color && [
                ...
                setThemeState(shop.color);
                localStorage.setItem(THEME_KEY, shop.color);
            }
        }
    }["SessionProvider.useCallback[selectShop]"], []);
    ...
    const setTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SessionProvider.useCallback[setTheme]": (t)=>{
            setThemeState(t);
            localStorage.setItem(THEME_KEY, t);
        }
    }["SessionProvider.useCallback[setTheme]"], []);
...
_s(SessionProvider, "u24zAjdZCNXTsoJ/uf18SEP8Fa8=");
_c = SessionProvider;
function useSession() {
    _s1();
...
function useShopHeader() {
    _s2();
    const { currentShop } = useSession();
    return currentShop?.id || '';
}
_s2(useShopHeader, "wXlOWDrD8HrHZHThMaRL5C1phjs=", false, function() {
    return [
        useSession
    ];
});
...
//# sourceMappingURL=src_0nipyug._.js.map